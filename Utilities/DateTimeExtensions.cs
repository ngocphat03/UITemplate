...
namespace AXitUnityTemplate.Utilities
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static long GetTimestampInSecond(this DateTime dateTime) { return DateTimeExtensions.GetTimestamp(dateTime).ToUnixTimeSeconds(); }

        public static DateTime ToDateTime(this long timestamp) { return DateTimeOffset.FromUnixTimeSeconds(timestamp).UtcDateTime; }

        public static long GetCurrentTimestampInSecond() { return DateTime.UtcNow.GetTimestamp().ToUnixTimeSeconds(); }

        public static long GetCurrentTimestampInMilliSecond() { return DateTime.UtcNow.GetTimestamp().ToUnixTimeMilliseconds(); }
