...
namespace AXitUnityTemplate.Blueprint.BlueprintReader.Converter.TypeConversion
{
    ...
    public class DefaultTypeConverter : ITypeConverter
    {
        ...
        public virtual object ConvertFromString(string text, Type typeInfo)
        {
            try
            {
                return JsonConvert.DeserializeObject(text, typeInfo, DefaultTypeConverter.JsonSetting);
            }
            catch (Exception)
            {
                var message =
        ...
        public virtual string ConvertToString(object value, Type typeInfo)
        {
            ...
            return JsonConvert.SerializeObject(value, DefaultTypeConverter.JsonSetting);
        }
    }
}